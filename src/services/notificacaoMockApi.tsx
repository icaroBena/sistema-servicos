// NOTE: notificacaoMockApi was a compatibility in-memory fallback used early in development.
// It is kept here for historical reasons but is no longer recommended — prefer src/api/notifications
// Components now use `src/api/notifications` or NotificationContext with its own in-memory fallback.
